...
replace age = 87 if QCAgeRes == 16 /* 16:85+ */
...
use TempFull, clear
include "02_JapanMTUS/2001/AuxVars2001.do"
...
********************************************************************************
gen     day = .
replace day = 1 if inlist(QDateRec, 14, 21)
replace day = 2 if inlist(QDateRec, 15)
replace day = 3 if inlist(QDateRec, 16)
replace day = 4 if inlist(QDateRec, 17)
replace day = 5 if inlist(QDateRec, 18)
replace day = 6 if inlist(QDateRec, 19)
replace day = 7 if inlist(QDateRec, 13, 20)
...
replace hhtype = 2  if  inlist(KHHType, 1, 12)
...
********************************************************************************
gen     ownhome =  .
replace ownhome =  1 if QHouseType == 1
replace ownhome =  2 if inlist(QHouseType, 2, 3, 4, 5)
...
replace empstat =  3 if inlist(QEmpStat, 4, 5, 6, 7, 8, 9, 10)
...
replace wrkhrs = 39 if QWorkHoursWeek == 3
...
********************************************************************************
gen     isco1 =  .
replace isco1 =  1 if KJob == 5
replace isco1 =  2 if inlist(KJob, 3, 4)
replace isco1 =  3 if KJob == 2
replace isco1 =  4 if KJob == 6
replace isco1 =  5 if inlist(KJob, 7, 8, 9, 10, 11)
replace isco1 =  6 if KJob == 12
replace isco1 =  8 if inlist(KJob, 15, 16)
replace isco1 =  9 if inlist(KJob, 13, 17) 
replace isco1 = -9 if KJob == 18
...
********************************************************************************
gen     edcat = .
replace edcat = 1 if inlist(QEduRes, 1, 2, 3, 6, 10)
replace edcat = 2 if inlist(QEduRes, 7)
replace edcat = 3 if inlist(QEduRes, 4, 5, 8, 9)
