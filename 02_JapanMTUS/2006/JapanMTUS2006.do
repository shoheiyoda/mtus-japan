...
include "02_JapanMTUS/2006/AuxVars2006.do"
...
********************************************************************************
gen     isco1 =  .
replace isco1 =  1 if KJob == 4
replace isco1 =  2 if inlist(KJob, 2, 3)
replace isco1 =  3 if KJob == 1
replace isco1 =  4 if KJob == 5
replace isco1 =  5 if inlist(KJob, 6, 7, 8, 9)
replace isco1 =  6 if KJob == 10
replace isco1 =  8 if inlist(KJob, 12, 13, 14)
replace isco1 =  9 if KJob == 11 
replace isco1 = -9 if KJob == 15
...
********************************************************************************
gen     edcat = .
replace edcat =  1 if inlist(QEduRes, 1, 2, 3, 6, .)
