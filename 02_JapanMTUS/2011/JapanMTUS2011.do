...
use TempFull, clear
include "02_JapanMTUS/2011/AuxVars2011.do"
...
********************************************************************************
gen     edcat = .
replace edcat =  1 if inlist(QEduRes, 1, 2, 3, 7, 12)
replace edcat =  2 if inlist(QEduRes, 8)
replace edcat =  3 if inlist(QEduRes, 4, 5, 6, 9, 10, 11)
replace edcat = -9 if inlist(QEduRes, .)
